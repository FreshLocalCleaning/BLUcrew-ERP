...
const columns = [
  ...
  columnHelper.accessor('status', {
    ...
    cell: (info) => (
      <StatusBadge
        state={info.getValue()}
        label={PROJECT_STATE_LABELS[info.getValue()]}
      />
    ),
  }),
  columnHelper.accessor('target_turnover_date', {
    header: 'Target Turnover',
    cell: (info) => {
  ...
  columnHelper.accessor('active_change_order_count', {
    header: 'COs',
    cell: (info) => (
      <span className="text-sm">{info.getValue()}</span>
    ),
