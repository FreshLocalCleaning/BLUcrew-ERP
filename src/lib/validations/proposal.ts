...
export const createProposalSchema = z.object({
  ...
  decision_target_date: z.string().nullable().optional(),
...
export const updateProposalSchema = z.object({
  ...
  acceptance_confirmation_method: ProposalAcceptanceMethodEnum.nullable().optional(),
  decision_cadence_next_date: z.string().nullable().optional(),
  external_notes: z.string().max(5000).nullable().optional(),
  next_action: z.string().max(500).optional(),
  next_action_date: z.string().optional(),
})
