...
import type { Client, Contact, Pursuit, ProjectSignal, ProjectSignalType, Estimate, Proposal, EstimatePricingSummary, AwardHandoff, ComplianceDocItem, StartupBlockerItem, Project, Mobilization, ReadinessChecklist, EquipmentChecklistItem } from '@/types/commercial'
...
if (typeof require !== 'undefined' && require.main === module) {
  ...
  seedProjects()
  seedMobilizations()
  console.log('Seeded 6 clients, 8 contacts, 5 project signals, 3 pursuits, 2 estimates, 1 proposal, 1 award/handoff, 1 project, and 2 mobilizations.')
}
