...
export function createClient(
  data: Omit<Client, db.AutoGeneratedKeys | db.DefaultableKeys | 'reference_id' | 'status' | 'contacts' | 'preferred_provider_candidate'>
    & Partial<Pick<Client, db.DefaultableKeys & keyof Client>>
    & { contacts?: string[]; preferred_provider_candidate?: boolean },
  actorId: string,
): Client {
  ...
  return db.create<Client>(
    COLLECTION,
    {
      ...
      preferred_provider_candidate: data.preferred_provider_candidate ?? false,
